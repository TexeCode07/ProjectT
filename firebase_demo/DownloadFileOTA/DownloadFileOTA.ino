...
#define WIFI_SSID "Elantra Zone"
#define WIFI_PASSWORD "Elantra@dream"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyDhZgykgUKvBHY44NgEPM0lChpa6_wM4Hw"

/* 3. Define the RTDB URL */
#define DATABASE_URL  "https://dropcon-78e5b-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "tejas.birute47@gmail.com"
#define USER_PASSWORD "tex@1234"
...
void setup()
{
    ...
    if (!LittleFS.begin(true)) {
      ...
      // File abc = LittleFS.open("/abc.bin", "w");
      // if (abc) {  
      //   const char *data = "Hello, LittleFS!";
      //   size_t dataSize = strlen(data);
      //   abc.write((uint8_t *)data, dataSize);
      //   abc.close();
      // }
      // abc.close();
    }
...
void loop()
{
    ...
    if (Firebase.ready() && !taskCompleted)
    {
        ...
        // if (!Firebase.setFile(fbdo, StorageType::FLASH, "/", "<config.txt>", rtdbUploadCallback))
